  ...
  const NavButton: React.FC<{
    ...
    >
      ...
      {count !== undefined && count > 0 && (
        <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-accent text-xs font-bold text-white">
          {count}
        </span>
      )}
    </button>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-4">
            <h1 className="text-xl font-bold text-white">AI Trade Alerts</h1>
            <nav className="flex items-center space-x-2 bg-gray-900 p-1 rounded-xl">
          ...
          <div className="flex items-center">
            <button
              onClick={onNewTrade}
              className="flex items-center justify-center bg-green-accent hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg transition-transform duration-200 hover:scale-105"
            >
              <PlusIcon />
